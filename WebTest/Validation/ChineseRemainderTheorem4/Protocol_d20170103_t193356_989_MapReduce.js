...
(function (global, factory) {
	if(typeof exports === 'object' && typeof module !== 'undefined') { 
		...
		global.Protocol_d20170103_t193356_989_MapReduce = factory();
	}
}(this, function () { 'use strict';


class Protocol_d20170103_t193356_989_MapReduce {
	...
	constructor(
		...
		this.automaton2 = new Protocol_d20170103_t193356_989_MapReduce_Automaton2();
		this.automaton28 = new Protocol_d20170103_t193356_989_MapReduce_Automaton28();
		this.automaton38 = new Protocol_d20170103_t193356_989_MapReduce_Automaton38();
		this.automaton48 = new Protocol_d20170103_t193356_989_MapReduce_Automaton48();
	...
	initialize() {
		...
		/*
		 * Initialize ports in automaton #28
		 */
		...
		/*
		 * Initialize ports in automaton #38
		 */
		...
		this.automaton28.initialize(this);
		this.automaton38.initialize(this);
		this.automaton48.initialize(this);
	}

	start() {
		this.automaton2.start();
		this.automaton28.start();
		this.automaton38.start();
		this.automaton48.start();
	}

}

class Protocol_d20170103_t193356_989_MapReduce_Automaton2 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t193356_989_MapReduce_Automaton2_State1();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton2_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition1 = new Protocol_d20170103_t193356_989_MapReduce_Automaton2_Transition1();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton2_Transition1 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.dataConstraint = new Protocol_d20170103_t193356_989_MapReduce_Automaton2_Transition1_DataConstraint(protocol, this);
...
;
	...
	class Protocol_d20170103_t193356_989_MapReduce_Automaton2_Transition1_DataConstraint {
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton28 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t193356_989_MapReduce_Automaton28_State1();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton28_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition2 = new Protocol_d20170103_t193356_989_MapReduce_Automaton28_Transition2();
	...
	initialize(protocol) {
		...
		this.successor = protocol.automaton28.state1;
		/*
		 * Set ports 
		 */
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton28_Transition2 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.context = protocol.automaton28.context;
		...
		this.dataConstraint = new Protocol_d20170103_t193356_989_MapReduce_Automaton28_Transition2_DataConstraint(protocol, this);

		/*
		 * Set target
		 */

		this.target = protocol.automaton28.state1;
...
;
	...
	class Protocol_d20170103_t193356_989_MapReduce_Automaton28_Transition2_DataConstraint {
...
class HandlerForp14$1 extends prdkCore.Handler {
	...
	constructor(protocol) {
		super(protocol.automaton28.semaphore);
		...
		this.state1 = protocol.automaton28.state1;
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton38 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.queue1 = new prdkCore.SingleReaderQueue(4);
		...
		this.state1 = new Protocol_d20170103_t193356_989_MapReduce_Automaton38_State1();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton38_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition9 = new Protocol_d20170103_t193356_989_MapReduce_Automaton38_Transition9();
	...
	initialize(protocol) {
		...
		this.successor = protocol.automaton38.state1;
		/*
		 * Set ports 
		 */
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton38_Transition9 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.context = protocol.automaton38.context;
		...
		this.queue1 = protocol.automaton38.queue1;

		/*
		 * Set data constraint and target
		 */

		this.dataConstraint = new Protocol_d20170103_t193356_989_MapReduce_Automaton38_Transition9_DataConstraint(protocol, this);

		/*
		 * Set target
		 */

		this.target = protocol.automaton38.state1;
...
;
	...
	class Protocol_d20170103_t193356_989_MapReduce_Automaton38_Transition9_DataConstraint {
...
class HandlerForp17$1 extends prdkCore.Handler {
	...
	constructor(protocol) {
		super(protocol.automaton38.semaphore);
		...
		this.state1 = protocol.automaton38.state1;
	...
	fireTransitionFromState1() {
		return this.state1.transition9.fire();
	}
}
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton48 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t193356_989_MapReduce_Automaton48_State1();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton48_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition9 = new Protocol_d20170103_t193356_989_MapReduce_Automaton48_Transition9();
...
class Protocol_d20170103_t193356_989_MapReduce_Automaton48_Transition9 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.queue1 = protocol.automaton48.queue1;

		/*
		 * Set data constraint and target
		 */

		this.dataConstraint = new Protocol_d20170103_t193356_989_MapReduce_Automaton48_Transition9_DataConstraint(protocol, this);
...
;
	...
	class Protocol_d20170103_t193356_989_MapReduce_Automaton48_Transition9_DataConstraint {
...
return Protocol_d20170103_t193356_989_MapReduce;
}));
