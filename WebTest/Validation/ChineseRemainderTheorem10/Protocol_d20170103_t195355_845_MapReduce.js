...
(function (global, factory) {
	if(typeof exports === 'object' && typeof module !== 'undefined') { 
		...
		global.Protocol_d20170103_t195355_845_MapReduce = factory();
	}
}(this, function () { 'use strict';


class Protocol_d20170103_t195355_845_MapReduce {
	...
	constructor(
		...
		this.automaton2 = new Protocol_d20170103_t195355_845_MapReduce_Automaton2();
		this.automaton52 = new Protocol_d20170103_t195355_845_MapReduce_Automaton52();
		this.automaton74 = new Protocol_d20170103_t195355_845_MapReduce_Automaton74();
		this.automaton96 = new Protocol_d20170103_t195355_845_MapReduce_Automaton96();
	...
	initialize() {
		...
		/*
		 * Initialize ports in automaton #52
		 */
...

		{
			...
			this.p3p10$1$7.handler = new HandlerForp3p10$1$7(this);
			this.p3p10$1$8.handler = new HandlerForp3p10$1$8(this);
			this.p3p10$1$9.handler = new HandlerForp3p10$1$9(this);
		}


		/*
		 * Initialize ports in automaton #96
		 */

		{
			this.p6p13$1$1.handler = new HandlerForp6p13$1$1(this);
			this.p6p13$1$10.handler = new HandlerForp6p13$1$10(this);
			...
			this.p6p13$1$7.handler = new HandlerForp6p13$1$7(this);
			this.p6p13$1$8.handler = new HandlerForp6p13$1$8(this);
			this.p6p13$1$9.handler = new HandlerForp6p13$1$9(this);
		...
		this.automaton52.initialize(this);
		this.automaton74.initialize(this);
		this.automaton96.initialize(this);
	}

	start() {
		this.automaton2.start();
		this.automaton52.start();
		this.automaton74.start();
		this.automaton96.start();
	}

}

class Protocol_d20170103_t195355_845_MapReduce_Automaton2 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t195355_845_MapReduce_Automaton2_State1();
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton2_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition1 = new Protocol_d20170103_t195355_845_MapReduce_Automaton2_Transition1();
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton2_Transition1 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.dataConstraint = new Protocol_d20170103_t195355_845_MapReduce_Automaton2_Transition1_DataConstraint(protocol, this);
...
;
	...
	class Protocol_d20170103_t195355_845_MapReduce_Automaton2_Transition1_DataConstraint {
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton52 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t195355_845_MapReduce_Automaton52_State1();
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton52_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition2 = new Protocol_d20170103_t195355_845_MapReduce_Automaton52_Transition2();
	...
	initialize(protocol) {
		...
		this.successor = protocol.automaton52.state1;
		/*
		 * Set ports 
		 */
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton52_Transition2 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.context = protocol.automaton52.context;
		...
		this.dataConstraint = new Protocol_d20170103_t195355_845_MapReduce_Automaton52_Transition2_DataConstraint(protocol, this);

		/*
		 * Set target
		 */

		this.target = protocol.automaton52.state1;
...
;
	...
	class Protocol_d20170103_t195355_845_MapReduce_Automaton52_Transition2_DataConstraint {
...
class HandlerForp14$1 extends prdkCore.Handler {
	...
	constructor(protocol) {
		super(protocol.automaton52.semaphore);
		...
		this.state1 = protocol.automaton52.state1;
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton74 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.queue1 = new prdkCore.SingleReaderQueue(10);
		...
		this.state1 = new Protocol_d20170103_t195355_845_MapReduce_Automaton74_State1();
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton74_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition21 = new Protocol_d20170103_t195355_845_MapReduce_Automaton74_Transition21();
	...
	initialize(protocol) {
		...
		this.successor = protocol.automaton74.state1;
		/*
		 * Set ports 
		 */
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton74_Transition21 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.context = protocol.automaton74.context;
		...
		this.queue1 = protocol.automaton74.queue1;

		/*
		 * Set data constraint and target
		 */

		this.dataConstraint = new Protocol_d20170103_t195355_845_MapReduce_Automaton74_Transition21_DataConstraint(protocol, this);

		/*
		 * Set target
		 */

		this.target = protocol.automaton74.state1;
...
;
	...
	class Protocol_d20170103_t195355_845_MapReduce_Automaton74_Transition21_DataConstraint {
...
class HandlerForp17$1 extends prdkCore.Handler {
	...
	constructor(protocol) {
		super(protocol.automaton74.semaphore);
		...
		this.state1 = protocol.automaton74.state1;
	...
	fireTransitionFromState1() {
		return this.state1.transition21.fire();
	}
}
...
class HandlerForp3p10$1$10 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton74.context;
		this.p3p10$1$10 = protocol.p3p10$1$10;
	...
	call() {
		if (this.p3p10$1$10.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p3p10$1$10.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p3p10$1$10, null, null));
	}
...
class HandlerForp3p10$1$7 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton74.context;
		this.p3p10$1$7 = protocol.p3p10$1$7;
	...
	call() {
		if (this.p3p10$1$7.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p3p10$1$7.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p3p10$1$7, null, null));
	}
...
class HandlerForp3p10$1$8 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton74.context;
		this.p3p10$1$8 = protocol.p3p10$1$8;
	...
	call() {
		if (this.p3p10$1$8.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p3p10$1$8.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p3p10$1$8, null, null));
	}
...
class HandlerForp3p10$1$9 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton74.context;
		this.p3p10$1$9 = protocol.p3p10$1$9;
	...
	call() {
		if (this.p3p10$1$9.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p3p10$1$9.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p3p10$1$9, null, null));
	}
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton96 extends prdkCore.Automaton {
	...
	constructor() {
		...
		this.state1 = new Protocol_d20170103_t195355_845_MapReduce_Automaton96_State1();
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton96_State1 extends prdkCore.State {
	...
	constructor() {
		...
		this.transition21 = new Protocol_d20170103_t195355_845_MapReduce_Automaton96_Transition21();
	...
	initialize(protocol) {
		...
		this.successor = protocol.automaton96.state1;
		/*
		 * Set ports 
		 */
...
class Protocol_d20170103_t195355_845_MapReduce_Automaton96_Transition21 extends prdkCore.Transition {
	...
	initialize(protocol) {
		...
		this.context = protocol.automaton96.context;
		...
		this.queue1 = protocol.automaton96.queue1;

		/*
		 * Set data constraint and target
		 */

		this.dataConstraint = new Protocol_d20170103_t195355_845_MapReduce_Automaton96_Transition21_DataConstraint(protocol, this);

		/*
		 * Set target
		 */

		this.target = protocol.automaton96.state1;
...
;
	...
	class Protocol_d20170103_t195355_845_MapReduce_Automaton96_Transition21_DataConstraint {
...
class HandlerForp21$1 extends prdkCore.Handler {
	...
	constructor(protocol) {
		super(protocol.automaton96.semaphore);
		...
		this.state1 = protocol.automaton96.state1;
...
class HandlerForp6p13$1$10 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton96.context;
		this.p6p13$1$10 = protocol.p6p13$1$10;
	...
	call() {
		if (this.p6p13$1$10.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p6p13$1$10.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p6p13$1$10, null, null));
	}
...
class HandlerForp6p13$1$7 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton96.context;
		this.p6p13$1$7 = protocol.p6p13$1$7;
	...
	call() {
		if (this.p6p13$1$7.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p6p13$1$7.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p6p13$1$7, null, null));
	}
...
class HandlerForp6p13$1$8 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton96.context;
		this.p6p13$1$8 = protocol.p6p13$1$8;
	...
	call() {
		if (this.p6p13$1$8.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p6p13$1$8.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p6p13$1$8, null, null));
	}
...
class HandlerForp6p13$1$9 extends prdkCore.Handler {
	...
	constructor(protocol) {
		...
		this.context = protocol.automaton96.context;
		this.p6p13$1$9 = protocol.p6p13$1$9;
	...
	call() {
		if (this.p6p13$1$9.status == prdkCore.IO.COMPLETED)
			return true;

		if (this.fireTransitionFromState1())
			return true;

		this.p6p13$1$9.semaphore.drainPermits();
		return false;
	}
	...
	flag() {
		this.queue1.offer(new prdkCore.SingleReaderQueueItem(this.p6p13$1$9, null, null));
	}
...
return Protocol_d20170103_t195355_845_MapReduce;
}));
